...
### 2. Скопировать и вставить команды скачивания проекта
...
### 3. Запустить первый этап установки
...
### 5. Включить вход и запросы авторизации по отпечатку
